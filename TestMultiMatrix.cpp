...
namespace TestMultiMatrix
{
	...
	public:
		...
		{
			ifstream in("/Users/varka/source/repos/MultiMatrixTest/in.txt");
			ofstream out("/Users/varka/source/repos/MultiMatrixTest/out.txt");
			...
			in.close();
			out.close();
			in.open("/Users/varka/source/repos/MultiMatrixTest/right_out.txt");
